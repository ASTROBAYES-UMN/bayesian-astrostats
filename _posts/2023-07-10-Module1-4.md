...
- Flip a coin once.𝒳 = {𝐻, 𝑇 }
- Flip a coin twice.𝒳 = {𝐻𝐻, 𝐻𝑇 , 𝑇 𝐻, 𝑇 𝑇 }
- Conduct an election. Observe proportion of votes for candidate A.𝒳 = [0, 1]
...
Notice that the empty set∅and𝒳are included inℱ, but∅cannot occur while𝒳is certain
to occur.

If|𝒳| < ∞, thenℱis the power set of𝒳. More generally, it is a𝜎-algebra, but if you are
